...
* Name: Abdirisak Arr                                       *
* Date: 20/09/2019                                          *
* Description: Modification of poker.c whereby the program  *
*              also recognises a royal flush                *
*************************************************************/
...
*               royal, a straight, a flush, four-of-a-kind  *
*               and/or three-of-a-kind; determines the      *
*               number of pairs; stores the results into    *
*               the external variables royal, straight,     *
...
void analyze_hand(void)
{
	...
	{
		num_consec++;
		if (rank > 7 && num_consec == NUM_CARDS)
		{
			royal = true;
		}
...
*               royal, straight, flush, four, three, and    *
*               pairs.                                      *
*************************************************************/
