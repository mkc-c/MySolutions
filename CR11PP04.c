...
* Name: Abdirisak Arr                                       *
* Date: 04/10/2019                                          *
* Description: Modification of poker.c program in which all *
*              external variables are moved into main and   *
*              and modified by arguments passes to functions*
*************************************************************/
...
/************************************************************
* main: Declares higher level program variables; calls      *
*       read_cards, analyze_hand, and print_result          *
*       repeatedly.                                         *
*************************************************************/
...
/************************************************************
* read_cards: Reads the cards into arguments in main that   *
*             correspond to parameters num_in_rank and      *
...
*               pairs; stores the results in arguments in   *
*               that correspond to parameters straight,     *
...
*               on the values of variables straight, flush, *
*               four, three, and pairs located in main.     *
*************************************************************/
